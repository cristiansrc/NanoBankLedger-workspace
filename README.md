...
| 2 | *"Definir las decisiones de alineación para el MVP NanoBank Ledger considerando: PostgreSQL vs NoSQL, Arquitectura Hexagonal, rotación de JWT, estructura monorepo, API-First, estrategia de testing, framework UI, despliegue y estrategia de migración."* | enterprise-architect | Alineación inicial del proyecto (9 decisiones locked) |
